...
<head>
  ...
  <style>
    ...
    :root{
      ...
      --muted: #8b7a8b;
      --card-bg: #fff;
      --page-bg: linear-gradient(135deg, #fef5f5 0%, #f9e9f0 100%);
      --radius: 20px;
    }
    *{box-sizing:border-box}
    ...
    .card{
      ...
      box-shadow:0 12px 35px rgba(200,125,142,0.15);
      padding:40px;
      display:grid;
    ...
    .contact{
      background: linear-gradient(135deg, rgba(247,231,231,0.5), rgba(249,233,240,0.5));
      padding:28px;
      border-radius:var(--radius);
      text-align:center;
    ...
    .btn{
      ...
      font-weight:600;
      font-family: 'Lato', sans-serif;
      box-shadow: 0 6px 20px rgba(199,125,142,0.3);
      transition: transform 0.3s ease, box-shadow 0.3s ease;
    }
    .btn:hover{
      transform: translateY(-2px);
      box-shadow: 0 8px 25px rgba(199,125,142,0.4);
    }
    .shop-image{
      width:100%;
      height:260px;
      ...
      <div>
        ...
        <section aria-labelledby="our-commitment">
          ...
          <footer class="note" role="contentinfo">
            <small>Tip: Replace placeholders with your real contact info, business registration (if any), and a link to adoption terms.</small>
          </footer>
        </section>
      </div>
